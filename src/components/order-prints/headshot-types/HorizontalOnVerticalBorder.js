...
class HorizontalOnVerticalBorder extends Component {
  state = {
    firstname: '',
    lastname: '',
    middlename: '',
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(materialStyles)(HorizontalOnVerticalBorder));
